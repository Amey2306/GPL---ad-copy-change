...
export const INITIAL_GOOGLE_ADS: AdCopy[] = [
    { field: 'Headline 1', text: 'Luxury Apartments in Mumbai' },
    { field: 'Headline 2', text: 'Godrej Properties | Now Selling' },
    { field: 'Headline 3', text: 'Starting at ₹2.5 Cr' },
    { field: 'Description 1', text: 'Experience unparalleled luxury with world-class amenities. Book your site visit today.' },
    { field: 'Description 2', text: 'Spacious 2 & 3 BHK homes in the heart of the city. Limited units available.' },
];

export const INITIAL_META_ADS: AdCopy[] = [
    { field: 'Primary Text', text: 'Discover your dream home with Godrej Properties. Our new project in Mumbai offers breathtaking views, state-of-the-art facilities, and a lifestyle of pure elegance. Click to learn more!' },
    { field: 'Headline', text: 'Luxury Living, Redefined' },
