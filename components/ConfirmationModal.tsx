...
const ConfirmationModal: React.FC<ConfirmationModalProps> = ({ isOpen, onClose, onConfirm, title, message }) => {
    ...
    return (
        ...
        >
            <div
                className="bg-gray-800/80 border border-gray-700 rounded-xl shadow-2xl w-full max-w-md flex flex-col overflow-hidden animate-fade-in-slide-up"
            ...
            >
                ...
                <footer className="flex-shrink-0 px-6 py-4 bg-gray-900/50 flex flex-row-reverse space-x-3 space-x-reverse">
                    <button
                        type="button"
                        onClick={onConfirm}
                    ...
                    <button
                        type="button"
                        onClick={onClose}
                        className="mt-3 w-full inline-flex justify-center rounded-md border border-gray-600 shadow-sm px-4 py-2 bg-gray-700 text-base font-medium text-gray-300 hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-sky-500 sm:mt-0 sm:w-auto sm:text-sm"
                    >
                        Cancel
                    </button>
                </footer>
