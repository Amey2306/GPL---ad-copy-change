...
const ConfirmationModal: React.FC<ConfirmationModalProps> = ({ isOpen, onClose, onConfirm, title, message }) => {
    ...
    return (
        <div 
            className="fixed inset-0 bg-slate-900 bg-opacity-60 z-50 flex items-center justify-center animate-fade-in"
            onClick={onClose}
        ...
        >
            <div
                className="bg-white rounded-xl shadow-2xl w-full max-w-md m-4 flex flex-col overflow-hidden animate-fade-in-slide-up"
