            ...
            <div className="space-y-8">
                <div className="flex flex-col space-y-4 bg-white p-6 rounded-xl border border-slate-200">
                    ...
                    <select
                        ...
                        className={`w-full p-3 bg-white border border-slate-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 text-sm ${!selectedProject ? 'text-slate-500' : 'text-slate-800'}`}
                    >
